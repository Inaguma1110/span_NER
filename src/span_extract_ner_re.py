...
dataname          = config.get('dataname', 'SPAN')### 'data' or 'Machining_data' or 'Machining_data_kakogijutsu'
...
writer_log_dir ='../../data/TensorboardGraph/span_NER_RE/LARGE_NEST_batch_size_{0}/learning_rate_{1}/network_{2}_{3}/0_logit_weight_{4}'.format(batch,lr_str,network_structure,attention_mask_is,weight)
brat_log_dir   = '../../brat/brat-v1.3_Crunchy_Frog/data/model_preds/span_NER_RE/LARGE_NEST_batch_size_{0}/learning_rate_{1}/network_{2}_{3}/0_logit_weight_{4}'.format(batch,lr_str,network_structure,attention_mask_is,weight)

hoge_dir = '../../data/TensorboardGraph/span_NER_RE/LARGE_NEST_debug'
...
############# index to texts ##########
    ...
    acc_span1 = accuracy_score(golds_span1,preds_span1)
    ...
    # print('span1 acc score is ' + str(acc_span1))
