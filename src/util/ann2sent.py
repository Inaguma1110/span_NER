import pdb
import os
# inputpath = "../../span_NER_RE/files/"
# outputpath = "../../span_NER_RE/files/target_data/"
input_path_list  = ["../../files_divided/train_devel/","../../files_devided/test/"]
output_path_list = ["../../files_divided/train_devel/target_data/","../../files_devided/test/target_data/"]

for inputpath, outputpath in zip(input_path_list, output_path_list):
    filelst = os.listdir(inputpath)
    doclist=[] # .txtと.annの同名のファイルをタプル形式にして保存する
